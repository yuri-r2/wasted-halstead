class Settings extends Phaser.Scene {
    ...
    create() {
		...
		var fontTitle = { font: '46px '+GM.text['FONT'], fill: '#D6DE49', stroke: '#000', strokeThickness: 7, align: 'center' };
		var fontSubtitle = { font: '38px '+GM.text['FONT'], fill: '#D6DE49', stroke: '#000', strokeThickness: 5, align: 'center' };
		var fontSmall = { font: '28px '+GM.text['FONT'], fill: '#D6DE49', stroke: '#000', strokeThickness: 4, align: 'center' };
		var titleSettings = this.add.text(GM.world.centerX, 60, GM.text['settings'], fontTitle);
		...
		this.textSound = this.add.text(offsetLeft+30+this.buttonSound.width, 250, GM.text['sound-on'], fontSubtitle);
		...
		this.textMusic = this.add.text(offsetLeft+30+this.buttonMusic.width, 375, GM.text['music-on'], fontSubtitle);
		...
		this.textCredits = this.add.text(offsetLeft+30+this.buttonCredits.width, 500, GM.text['credits'], fontSubtitle);
		this.textCredits.setOrigin(0, 0.5);		

        this.bannerBeer = new Button(GM.world.centerX, GM.world.height-60, 'banner-beer', this.clickBeer, this, 'static');
		this.bannerBeer.setOrigin(0.5, 1);
		
		// if(document.monetization && document.monetization.state === 'started') {
		// 	this.bannerBeer.destroy();
		// 	this.add.text(GM.world.centerX, GM.world.height-60, 'Thank you\nfor supporting GM!', fontSubtitle).setOrigin(0.5, 1);
		// }
		...
		// GM.Sfx.update('sound', this.buttonSound, this.textSound);
		// GM.Sfx.update('music', this.buttonMusic, this.textMusic);
		...
		if(this.sys.game.device.os.desktop) {
			this.helpText = this.add.text(GM.world.centerX, GM.world.height-250, GM.text['keyboard-info'], fontSmall);
		...
		this.containerCredits = this.add.container(0, GM.world.height);
		...
		var titleCredits = this.add.text(GM.world.centerX, offsetTopCredits+40, GM.text['credits'], fontTitle);
		titleCredits.setOrigin(0.5);
		var titleCreditsText = this.add.text(GM.world.centerX, offsetTopCredits+170, GM.text['madeby'], fontSubtitle);
		titleCreditsText.setOrigin(0.5,0);
		var titleCreditsLogo = new Button(GM.world.centerX, offsetTopCredits+270, 'logo-enclave', this.clickEnclave, this, 'noframes');
		titleCreditsLogo.setOrigin(0.5,0);
		var titleCreditsUrl = this.add.text(GM.world.centerX, offsetTopCredits+400, 'enclavegames.com', fontSubtitle);
		...
		var titleCrew = this.add.text(GM.world.centerX, offsetTopCrew, GM.text['team'], fontSubtitle);
		titleCrew.setOrigin(0.5,0);
		var titleCrewAndrzej = this.add.text(GM.world.centerX, offsetTopCrew+80, 'Andrzej Mazur - '+GM.text['coding'], fontSubtitle);
		titleCrewAndrzej.setOrigin(0.5,0);
		var titleCrewEwa = this.add.text(GM.world.centerX, offsetTopCrew+140, 'Ewa Mazur - '+GM.text['design'], fontSubtitle);
		titleCrewEwa.setOrigin(0.5,0);
		var titleCrewKasia = this.add.text(GM.world.centerX, offsetTopCrew+200, 'Kasia Mazur - '+GM.text['testing'], fontSubtitle);
		titleCrewKasia.setOrigin(0.5,0);
		var titleCreditsMusic = this.add.text(GM.world.centerX, offsetTopCrew+320, GM.text['musicby']+' Bensound', fontSubtitle);
		...
		this.containerKeyboard.y = GM.world.height;
		
		var offsetTopKeyboard = 20;
		var keyboardBg = this.add.sprite(0, 0, 'background');
		keyboardBg.setOrigin(0,0);
		var titleKeyboard = this.add.text(GM.world.centerX, offsetTopKeyboard+40, GM.text['key-title'], fontTitle);
		titleKeyboard.setOrigin(0.5);
		var titleKeySettingsTitle = this.add.text(GM.world.centerX, offsetTopKeyboard+90, GM.text['key-settings-title'], fontSubtitle);
		titleKeySettingsTitle.setOrigin(0.5,0);
		var titleKeySettings = this.add.text(GM.world.centerX, offsetTopKeyboard+140, GM.text['key-settings-onoff'], fontSmall);
		titleKeySettings.setOrigin(0.5,0);
		var titleKeyAudio = this.add.text(GM.world.centerX, offsetTopKeyboard+180, GM.text['key-audio'], fontSmall);
		titleKeyAudio.setOrigin(0.5,0);
		var titleKeyMusic = this.add.text(GM.world.centerX, offsetTopKeyboard+220, GM.text['key-music'], fontSmall);
		titleKeyMusic.setOrigin(0.5,0);
		var titleKeyCredits = this.add.text(GM.world.centerX, offsetTopKeyboard+260, GM.text['key-credits'], fontSmall);
		titleKeyCredits.setOrigin(0.5,0);
		var titleKeyKeyboard = this.add.text(GM.world.centerX, offsetTopKeyboard+300, GM.text['key-shortcuts'], fontSmall);
		titleKeyKeyboard.setOrigin(0.5,0);

		var titleKeyMenuTitle = this.add.text(GM.world.centerX, offsetTopKeyboard+350, GM.text['key-menu'], fontSubtitle);
		titleKeyMenuTitle.setOrigin(0.5,0);
		var titleKeySettings2 = this.add.text(GM.world.centerX, offsetTopKeyboard+400, GM.text['key-settings-onoff'], fontSmall);
		titleKeySettings2.setOrigin(0.5,0);
		var titleKeyStart = this.add.text(GM.world.centerX, offsetTopKeyboard+440, GM.text['key-start'], fontSmall);
		titleKeyStart.setOrigin(0.5,0);

		var titleKeyGameTitle = this.add.text(GM.world.centerX, offsetTopKeyboard+490, GM.text['key-gameplay'], fontSubtitle);
		titleKeyGameTitle.setOrigin(0.5,0);
		var titleKeyButton = this.add.text(GM.world.centerX, offsetTopKeyboard+540, GM.text['key-button'], fontSmall);
		titleKeyButton.setOrigin(0.5,0);
		var titleKeyPause = this.add.text(GM.world.centerX, offsetTopKeyboard+580, GM.text['key-pause'], fontSmall);
		titleKeyPause.setOrigin(0.5,0);

		var titleKeyPauseTitle = this.add.text(GM.world.centerX, offsetTopKeyboard+630, GM.text['key-pause-title'], fontSubtitle);
		titleKeyPauseTitle.setOrigin(0.5,0);
		var titleKeyBack = this.add.text(GM.world.centerX, offsetTopKeyboard+680, GM.text['key-back'], fontSmall);
		titleKeyBack.setOrigin(0.5,0);
		var titleKeyRestart = this.add.text(GM.world.centerX, offsetTopKeyboard+720, GM.text['key-return'], fontSmall);
		titleKeyRestart.setOrigin(0.5,0);

		var titleKeyOverTitle = this.add.text(GM.world.centerX, offsetTopKeyboard+770, GM.text['key-gameover'], fontSubtitle);
		titleKeyOverTitle.setOrigin(0.5,0);
		var titleKeyBack2 = this.add.text(GM.world.centerX, offsetTopKeyboard+820, GM.text['key-back'], fontSmall);
		titleKeyBack2.setOrigin(0.5,0);
		var titleKeyRestart2 = this.add.text(GM.world.centerX, offsetTopKeyboard+860, GM.text['key-try'], fontSmall);
	...
	clickSound() {
		...
		// GM.Sfx.manage('sound', 'switch', this, this.buttonSound, this.textSound);
	}
	clickMusic() {
		GM.Sfx.play('click', this);
		// GM.Sfx.manage('music', 'switch', this, this.buttonMusic, this.textMusic);
	}
	clickCredits() {
		GM.Sfx.play('click', this);
	...
	clickBack(name) {
		...
		if(name) {
			...
			if(name == 'credits') {
				this.tweens.add({targets: this.containerCredits, y: GM.world.height, duration: 750, ease: 'Cubic.easeIn' });
			}
			else if(name == 'keyboard') {
				this.tweens.add({targets: this.containerKeyboard, y: GM.world.height, duration: 750, ease: 'Cubic.easeIn' });
			}
			this.screenName = 'settings';
		}
		else {
